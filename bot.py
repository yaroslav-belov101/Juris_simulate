...
async def cmd_start(message: types.Message):
    ...
    welcome_text = (
        ...
        "• 🛡️ <b>Адвокат</b> — защищает права гражданина\n"
        "• ⚖️ <b>Прокурор</b> — выявляет нарушения закона\n\n"
        "👉 Ваша роль по умолчанию: <b>🛡️ Адвокат</b>.\n"
...
async def cmd_help(message: types.Message):
    text = (
        "🎓 <b>Юридический симулятор: Адвокат vs Прокурор</b>\n\n"
        "Этот бот помогает понять, что право — это не просто правила, а <b>аргументация и позиция</b>.\n\n"
        "🔹 <b>🛡️ ЗащитАдвокатник</b> — защищает права гражданина.\n"
...
async def cmd_about(message: types.Message):
    text = (
        ...
        "<b>Особенности:</b>\n"
        "• Две юридические роли: адвокат и прокурор\n"
...
async def handle_messages(message: types.Message):
    ...
    if text == "🔄 Сменить роль":
        ...
        role_text = "⚖️ Прокурор" if new_role == "prosecutor" else "🛡️ Адвокат"
